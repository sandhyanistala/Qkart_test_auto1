...
public class Home {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status=driver.findElement(By.xpath("//*[starts-with(text(),' No ')]")).isDisplayed();           
           Thread.sleep(5000);
            return status;
        } catch (Exception e) {
            return status;
    ...
    public Boolean addProductToCart(String productName) {
        try {
            ...
            driver.findElements(By.className("MuiCardContent-root"));
             WebElement addToCardElement=driver.findElement(By.cssSelector(".MuiCardActions-root>button"));
    ...
    /*
     * Return Boolean deno``ting the status of change quantity of product in cart
     * operation
     */
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
       boolean flag =false;
        try {
           ...
           //(//div[@class,'MuiBox-root css1gjj37g']"));)
